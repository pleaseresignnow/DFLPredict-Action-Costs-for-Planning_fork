...
path = 'result_small/rovers_local/'
...
for model in model_lists:
    ...
    # lambda_val = int(result.split('lambda', 1)[-1])
...
#                        'caching10SPOallone', 'caching10SPOaddminallone',
...
problems_to_compare = [ 'roversmall1.', 'roversmall3.' ,  'rovers01.' ,'rovers02.', 'rovers03.' ]
...
for problem in problems_to_compare:
    ...
    # rslt_subsetdf = rslt_subsetdf[rslt_subsetdf['lr']==0.05]
    ...
    for main_model, sub_models  in model_classes.items():
            ...
            # train_model = "Training"+ main_model
            # if main_model in perturbed_models:
