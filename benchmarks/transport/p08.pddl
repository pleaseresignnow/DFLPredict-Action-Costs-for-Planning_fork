; Transport two-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-4packages-561seed

(define (problem transport-two-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-4packages-561seed)
 (:domain transport)
 (:objects
