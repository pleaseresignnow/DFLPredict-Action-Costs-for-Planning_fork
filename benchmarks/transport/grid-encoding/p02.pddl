(define (problem transport-grid)
 ...
 (road A2 A1)  (= (road-length A2 A1) 100)
 (road A3 A2)  (= (road-length A3 A2) 100)
 (road A4 A3)  (= (road-length A4 A3) 100)
 (road A5 A4)  (= (road-length A5 A4) 100)
 (road B2 B1)  (= (road-length B2 B1) 100)
 (road B3 B2)  (= (road-length B3 B2) 100)
 (road B4 B3)  (= (road-length B4 B3) 100)
 (road B5 B4)  (= (road-length B5 B4) 100)
 (road C2 C1)  (= (road-length C2 C1) 100)
 (road C3 C2)  (= (road-length C3 C2) 100)
 (road C4 C3)  (= (road-length C4 C3) 100)
 (road C5 C4)  (= (road-length C5 C4) 100)
 (road D2 D1)  (= (road-length D2 D1) 100)
 (road D3 D2)  (= (road-length D3 D2) 100)
 (road D4 D3)  (= (road-length D4 D3) 100)
 (road D5 D4)  (= (road-length D5 D4) 100)
 (road E2 E1)  (= (road-length E2 E1) 100)
 (road E3 E2)  (= (road-length E3 E2) 100)
 (road E4 E3)  (= (road-length E4 E3) 100)
 (road E5 E4)  (= (road-length E5 E4) 100)
  (at truck-1 A5)
