; Transport city-sequential-6nodes-1000size-3degree-100mindistance-3trucks-4packages-561seed

(define (problem transport-city-sequential-6nodes-1000size-3degree-100mindistance-3trucks-4packages-561seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
