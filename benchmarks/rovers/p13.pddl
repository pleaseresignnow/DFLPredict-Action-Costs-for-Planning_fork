...
(define (problem roverprob17923-3)
        ...
        (:init (visible waypoint0 waypoint6) (visible waypoint6 waypoint0)
         ...
         (= (traverse_cost rover0 waypoint10 waypoint2) 924)
         (= (traverse_cost rover0 waypoint2 waypoint10) 844)
         (= (traverse_cost rover0 waypoint10 waypoint9) 408)
         (= (traverse_cost rover0 waypoint9 waypoint10) 980)
         (= (traverse_cost rover0 waypoint2 waypoint3) 1052)
         (= (traverse_cost rover0 waypoint3 waypoint2) 1138)
         (= (traverse_cost rover0 waypoint2 waypoint11) 277)
         (= (traverse_cost rover0 waypoint11 waypoint2) 368)
         (= (traverse_cost rover0 waypoint2 waypoint13) 94)
         (= (traverse_cost rover0 waypoint13 waypoint2) 189)
         (= (traverse_cost rover0 waypoint9 waypoint8) 368)
         (= (traverse_cost rover0 waypoint8 waypoint9) 546)
         (= (traverse_cost rover0 waypoint9 waypoint14) 250)
         (= (traverse_cost rover0 waypoint14 waypoint9) 323)
         (= (traverse_cost rover0 waypoint3 waypoint5) 874)
         (= (traverse_cost rover0 waypoint5 waypoint3) 790)
         (= (traverse_cost rover0 waypoint3 waypoint6) 783)
         (= (traverse_cost rover0 waypoint6 waypoint3) 619)
         (= (traverse_cost rover0 waypoint3 waypoint7) 879)
         (= (traverse_cost rover0 waypoint7 waypoint3) 945)
         (= (traverse_cost rover0 waypoint3 waypoint12) 514)
         (= (traverse_cost rover0 waypoint12 waypoint3) 768)
         (= (traverse_cost rover0 waypoint11 waypoint0) 1008)
         (= (traverse_cost rover0 waypoint0 waypoint11) 553)
         (= (traverse_cost rover0 waypoint13 waypoint1) 390)
         (= (traverse_cost rover0 waypoint1 waypoint13) 543)
         (= (traverse_cost rover0 waypoint13 waypoint4) 536)
         (= (traverse_cost rover0 waypoint4 waypoint13) 500)
         (= (total-cost) 0))
        (:goal
