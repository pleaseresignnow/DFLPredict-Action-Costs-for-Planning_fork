...
(define (problem roverprob17923-4)
        ...
        (:init (visible waypoint0 waypoint6) (visible waypoint6 waypoint0)
         ...
         (= (traverse_cost rover0 waypoint10 waypoint2) 710)
         (= (traverse_cost rover0 waypoint2 waypoint10) 803)
         (= (traverse_cost rover0 waypoint10 waypoint9) 623)
         (= (traverse_cost rover0 waypoint9 waypoint10) 1089)
         (= (traverse_cost rover0 waypoint2 waypoint3) 659)
         (= (traverse_cost rover0 waypoint3 waypoint2) 512)
         (= (traverse_cost rover0 waypoint2 waypoint11) 436)
         (= (traverse_cost rover0 waypoint11 waypoint2) 546)
         (= (traverse_cost rover0 waypoint2 waypoint13) 169)
         (= (traverse_cost rover0 waypoint13 waypoint2) 128)
         (= (traverse_cost rover0 waypoint9 waypoint8) 439)
         (= (traverse_cost rover0 waypoint8 waypoint9) 556)
         (= (traverse_cost rover0 waypoint9 waypoint14) 154)
         (= (traverse_cost rover0 waypoint14 waypoint9) 181)
         (= (traverse_cost rover0 waypoint3 waypoint5) 333)
         (= (traverse_cost rover0 waypoint5 waypoint3) 563)
         (= (traverse_cost rover0 waypoint3 waypoint6) 920)
         (= (traverse_cost rover0 waypoint6 waypoint3) 560)
         (= (traverse_cost rover0 waypoint3 waypoint7) 823)
         (= (traverse_cost rover0 waypoint7 waypoint3) 1108)
         (= (traverse_cost rover0 waypoint3 waypoint12) 595)
         (= (traverse_cost rover0 waypoint12 waypoint3) 295)
         (= (traverse_cost rover0 waypoint11 waypoint0) 1164)
         (= (traverse_cost rover0 waypoint0 waypoint11) 852)
         (= (traverse_cost rover0 waypoint13 waypoint1) 532)
         (= (traverse_cost rover0 waypoint1 waypoint13) 477)
         (= (traverse_cost rover0 waypoint13 waypoint4) 441)
         (= (traverse_cost rover0 waypoint4 waypoint13) 995)
         (= (traverse_cost rover1 waypoint0 waypoint1) 331)
         (= (traverse_cost rover1 waypoint1 waypoint0) 330)
         (= (traverse_cost rover1 waypoint0 waypoint5) 264)
         (= (traverse_cost rover1 waypoint5 waypoint0) 360)
         (= (traverse_cost rover1 waypoint0 waypoint6) 60)
         (= (traverse_cost rover1 waypoint6 waypoint0) 54)
         (= (traverse_cost rover1 waypoint0 waypoint7) 274)
         (= (traverse_cost rover1 waypoint7 waypoint0) 150)
         (= (traverse_cost rover1 waypoint0 waypoint11) 1144)
         (= (traverse_cost rover1 waypoint11 waypoint0) 583)
         (= (traverse_cost rover1 waypoint0 waypoint13) 1194)
         (= (traverse_cost rover1 waypoint13 waypoint0) 612)
         (= (traverse_cost rover1 waypoint0 waypoint14) 700)
         (= (traverse_cost rover1 waypoint14 waypoint0) 831)
         (= (traverse_cost rover1 waypoint1 waypoint8) 388)
         (= (traverse_cost rover1 waypoint8 waypoint1) 607)
         (= (traverse_cost rover1 waypoint1 waypoint12) 578)
         (= (traverse_cost rover1 waypoint12 waypoint1) 293)
         (= (traverse_cost rover1 waypoint5 waypoint2) 649)
         (= (traverse_cost rover1 waypoint2 waypoint5) 491)
         (= (traverse_cost rover1 waypoint6 waypoint3) 666)
         (= (traverse_cost rover1 waypoint3 waypoint6) 672)
         (= (traverse_cost rover1 waypoint11 waypoint9) 473)
         (= (traverse_cost rover1 waypoint9 waypoint11) 729)
         (= (traverse_cost rover1 waypoint13 waypoint4) 667)
         (= (traverse_cost rover1 waypoint4 waypoint13) 528)
         (= (traverse_cost rover1 waypoint2 waypoint10) 716)
         (= (traverse_cost rover1 waypoint10 waypoint2) 1138)
         (= (total-cost) 0))
        (:goal
