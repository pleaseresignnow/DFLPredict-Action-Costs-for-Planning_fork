...
(define (problem roverprob31337-3)
        ...
        (:init (visible waypoint0 waypoint5) (visible waypoint5 waypoint0)
         ...
         (= (traverse_cost rover0 waypoint6 waypoint0) 721)
         (= (traverse_cost rover0 waypoint0 waypoint6) 479)
         (= (traverse_cost rover0 waypoint6 waypoint1) 581)
         (= (traverse_cost rover0 waypoint1 waypoint6) 685)
         (= (traverse_cost rover0 waypoint6 waypoint2) 421)
         (= (traverse_cost rover0 waypoint2 waypoint6) 397)
         (= (traverse_cost rover0 waypoint6 waypoint5) 326)
         (= (traverse_cost rover0 waypoint5 waypoint6) 354)
         (= (traverse_cost rover0 waypoint6 waypoint7) 587)
         (= (traverse_cost rover0 waypoint7 waypoint6) 639)
         (= (traverse_cost rover0 waypoint6 waypoint8) 544)
         (= (traverse_cost rover0 waypoint8 waypoint6) 652)
         (= (traverse_cost rover0 waypoint0 waypoint4) 473)
         (= (traverse_cost rover0 waypoint4 waypoint0) 824)
         (= (traverse_cost rover0 waypoint0 waypoint9) 606)
         (= (traverse_cost rover0 waypoint9 waypoint0) 597)
         (= (traverse_cost rover0 waypoint1 waypoint3) 325)
         (= (traverse_cost rover0 waypoint3 waypoint1) 400)
         (= (traverse_cost rover1 waypoint3 waypoint1) 795)
         (= (traverse_cost rover1 waypoint1 waypoint3) 502)
         (= (traverse_cost rover1 waypoint3 waypoint4) 463)
         (= (traverse_cost rover1 waypoint4 waypoint3) 480)
         (= (traverse_cost rover1 waypoint3 waypoint5) 523)
         (= (traverse_cost rover1 waypoint5 waypoint3) 679)
         (= (traverse_cost rover1 waypoint3 waypoint8) 526)
         (= (traverse_cost rover1 waypoint8 waypoint3) 287)
         (= (traverse_cost rover1 waypoint1 waypoint2) 373)
         (= (traverse_cost rover1 waypoint2 waypoint1) 365)
         (= (traverse_cost rover1 waypoint1 waypoint6) 750)
         (= (traverse_cost rover1 waypoint6 waypoint1) 413)
         (= (traverse_cost rover1 waypoint1 waypoint9) 585)
         (= (traverse_cost rover1 waypoint9 waypoint1) 493)
         (= (traverse_cost rover1 waypoint5 waypoint0) 275)
         (= (traverse_cost rover1 waypoint0 waypoint5) 226)
         (= (traverse_cost rover1 waypoint2 waypoint7) 290)
         (= (traverse_cost rover1 waypoint7 waypoint2) 287)
         (= (total-cost) 0))
        (:goal
