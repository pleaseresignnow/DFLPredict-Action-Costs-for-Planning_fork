...
(define (problem roverprob17923-5)
        ...
        (:init (visible waypoint0 waypoint8) (visible waypoint8 waypoint0)
         ...
         (= (traverse_cost rover0 waypoint11 waypoint1) 527)
         (= (traverse_cost rover0 waypoint1 waypoint11) 473)
         (= (traverse_cost rover0 waypoint11 waypoint5) 507)
         (= (traverse_cost rover0 waypoint5 waypoint11) 884)
         (= (traverse_cost rover0 waypoint1 waypoint0) 475)
         (= (traverse_cost rover0 waypoint0 waypoint1) 433)
         (= (traverse_cost rover0 waypoint1 waypoint7) 472)
         (= (traverse_cost rover0 waypoint7 waypoint1) 317)
         (= (traverse_cost rover0 waypoint1 waypoint10) 708)
         (= (traverse_cost rover0 waypoint10 waypoint1) 496)
         (= (traverse_cost rover0 waypoint1 waypoint14) 688)
         (= (traverse_cost rover0 waypoint14 waypoint1) 634)
         (= (traverse_cost rover0 waypoint1 waypoint15) 85)
         (= (traverse_cost rover0 waypoint15 waypoint1) 156)
         (= (traverse_cost rover0 waypoint1 waypoint16) 825)
         (= (traverse_cost rover0 waypoint16 waypoint1) 563)
         (= (traverse_cost rover0 waypoint5 waypoint8) 914)
         (= (traverse_cost rover0 waypoint8 waypoint5) 518)
         (= (traverse_cost rover0 waypoint5 waypoint9) 502)
         (= (traverse_cost rover0 waypoint9 waypoint5) 495)
         (= (traverse_cost rover0 waypoint5 waypoint12) 790)
         (= (traverse_cost rover0 waypoint12 waypoint5) 815)
         (= (traverse_cost rover0 waypoint5 waypoint18) 236)
         (= (traverse_cost rover0 waypoint18 waypoint5) 303)
         (= (traverse_cost rover0 waypoint0 waypoint17) 501)
         (= (traverse_cost rover0 waypoint17 waypoint0) 489)
         (= (traverse_cost rover0 waypoint0 waypoint19) 934)
         (= (traverse_cost rover0 waypoint19 waypoint0) 478)
         (= (traverse_cost rover0 waypoint7 waypoint4) 471)
         (= (traverse_cost rover0 waypoint4 waypoint7) 329)
         (= (traverse_cost rover0 waypoint14 waypoint3) 729)
         (= (traverse_cost rover0 waypoint3 waypoint14) 359)
         (= (traverse_cost rover0 waypoint15 waypoint2) 789)
         (= (traverse_cost rover0 waypoint2 waypoint15) 940)
         (= (traverse_cost rover0 waypoint15 waypoint6) 627)
         (= (traverse_cost rover0 waypoint6 waypoint15) 304)
         (= (traverse_cost rover0 waypoint16 waypoint13) 337)
         (= (traverse_cost rover0 waypoint13 waypoint16) 364)
         (= (total-cost) 0))
        (:goal
         (and (communicated_soil_data waypoint19)
