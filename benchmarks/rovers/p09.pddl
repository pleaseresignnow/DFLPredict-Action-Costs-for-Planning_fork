...
(define (problem roverprob19841-5)
        ...
        (:init (visible waypoint0 waypoint7) (visible waypoint7 waypoint0)
         ...
         (= (traverse_cost rover0 waypoint9 waypoint1) 910)
         (= (traverse_cost rover0 waypoint1 waypoint9) 635)
         (= (traverse_cost rover0 waypoint9 waypoint2) 140)
         (= (traverse_cost rover0 waypoint2 waypoint9) 190)
         (= (traverse_cost rover0 waypoint9 waypoint4) 157)
         (= (traverse_cost rover0 waypoint4 waypoint9) 201)
         (= (traverse_cost rover0 waypoint9 waypoint5) 250)
         (= (traverse_cost rover0 waypoint5 waypoint9) 448)
         (= (traverse_cost rover0 waypoint9 waypoint6) 632)
         (= (traverse_cost rover0 waypoint6 waypoint9) 558)
         (= (traverse_cost rover0 waypoint9 waypoint11) 577)
         (= (traverse_cost rover0 waypoint11 waypoint9) 642)
         (= (traverse_cost rover0 waypoint1 waypoint3) 519)
         (= (traverse_cost rover0 waypoint3 waypoint1) 265)
         (= (traverse_cost rover0 waypoint1 waypoint10) 129)
         (= (traverse_cost rover0 waypoint10 waypoint1) 104)
         (= (traverse_cost rover0 waypoint1 waypoint13) 67)
         (= (traverse_cost rover0 waypoint13 waypoint1) 156)
         (= (traverse_cost rover0 waypoint2 waypoint7) 249)
         (= (traverse_cost rover0 waypoint7 waypoint2) 181)
         (= (traverse_cost rover0 waypoint2 waypoint12) 1014)
         (= (traverse_cost rover0 waypoint12 waypoint2) 586)
         (= (traverse_cost rover0 waypoint4 waypoint14) 477)
         (= (traverse_cost rover0 waypoint14 waypoint4) 1073)
         (= (traverse_cost rover0 waypoint5 waypoint8) 160)
         (= (traverse_cost rover0 waypoint8 waypoint5) 141)
         (= (total-cost) 0))
        (:goal
