...
(define (problem roverprob17923-4)
        ...
        (:init (visible waypoint0 waypoint4) (visible waypoint4 waypoint0)
         ...
         (= (traverse_cost rover0 waypoint9 waypoint0) 718)
         (= (traverse_cost rover0 waypoint0 waypoint9) 871)
         (= (traverse_cost rover0 waypoint9 waypoint1) 925)
         (= (traverse_cost rover0 waypoint1 waypoint9) 768)
         (= (traverse_cost rover0 waypoint9 waypoint3) 1013)
         (= (traverse_cost rover0 waypoint3 waypoint9) 879)
         (= (traverse_cost rover0 waypoint9 waypoint6) 1026)
         (= (traverse_cost rover0 waypoint6 waypoint9) 1025)
         (= (traverse_cost rover0 waypoint9 waypoint8) 557)
         (= (traverse_cost rover0 waypoint8 waypoint9) 508)
         (= (traverse_cost rover0 waypoint1 waypoint7) 354)
         (= (traverse_cost rover0 waypoint7 waypoint1) 709)
         (= (total-cost) 0))
        (:goal
